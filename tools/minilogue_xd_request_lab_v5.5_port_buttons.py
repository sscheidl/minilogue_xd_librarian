#!/usr/bin/env python3
"""
minilogue_xd_request_lab_v5.5_port_buttons.py
...
class RequestLab:
    def __init__(self, root: tk.Tk) -> None:
        ...
        self._build_gui()
        self._log("v5.5 Port Buttons: auto-open all XD ports; adds explicit PC+Current Port 1/Port 2/Both buttons.")
    ...
    def _build_gui(self) -> None:
        ...
        ttk.Button(req, text="PC+Current P1", command=self.request_slot_via_pc_port1).grid(row=0, column=4, padx=4, pady=6)
        ttk.Button(req, text="PC+Current P2", command=self.request_slot_via_pc_port2).grid(row=0, column=5, padx=4, pady=6)
        ttk.Button(req, text="PC+Current Both", command=self.request_slot_via_pc_both).grid(row=0, column=6, padx=4, pady=6)
        ttk.Button(req, text="Listen manual dump", command=self.listen_manual).grid(row=0, column=7, padx=4, pady=6)
        ttk.Button(req, text="Cancel", command=self.cancel_operation).grid(row=0, column=8, padx=4, pady=6)
